...
class DrawerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DrawerTheme(
      data: const DrawerThemeData(backgroundColor: Color(0xff5E6672), scrimColor: Colors.transparent, elevation: 0.5),
      child: Drawer(
        child: ListView(
          children: [
            ListTile(
            ...
            for (int i = 0; i < items().length; i++)
              {
                ListTile(
                  onTap: () {
                    ...
                    if (route != null) {
                      route.settings.name == listOfWidgets[i] ? isSameRoute = true : isSameRoute = false;
                    }
                    print(listOfWidgets[i]);
                    if(!isSameRoute) Navigator.pushNamed(context, listOfWidgets[i]);
                    if(isSameRoute) Navigator.pop(context);
                  },
