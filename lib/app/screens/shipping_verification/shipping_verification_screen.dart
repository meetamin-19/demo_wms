        ...
        body: Scaffold(
          body: Stack(
            children: [
              ...
              if(!isListLoaded) Center(child: LoadingSmall(color: Colors.blue,size: 50,),)
            ],
          ),
      ...
      child: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration( border: Border.all(style: BorderStyle.solid,color: Colors.black.withOpacity(0.1))),
            child: Table(
