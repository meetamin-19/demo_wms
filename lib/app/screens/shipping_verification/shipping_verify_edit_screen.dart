...
class _ShippingVerifyEditScreenState extends State<ShippingVerifyEditScreen> {
                          ...
                          child: Wrap(
                            ...
                            children: [
                              ...
                              keyValueBox(
                                  ...
                                  key: 'Billing Address :',
                                  value:
                                      'Caterpiller Inc. 100 N.E. Adams St. Peoria, IL 61629616 61629'),
                              keyValueBox(
                                  width: width / 2,
                                  key: 'Ship To Address :',
                                  value:
                                      '1Ship To : BCP North America MHE/STTT BCP North America MHE/STTT 250 Dozer Dr. Athens GA 30606'),
                            ],
                          ),
                        );
                      },
            ...
            showSubmitButton
                ? Padding(
                    ...
                    child: Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            // var d1 = data?.data?.pickOrderPalletList
                            //     ?.map((e) => e.isPalletVerified)
                            //     .toList();
                            _submitUnverifiedData();
                            // print(d1?.contains(false));
                          },
                          child: isLoading ? LoadingSmall(color: Colors.white,) : Text(
                            "SUBMIT",
  ...
  _submitUnverifiedData() async {
    ...
    if(edited){
      ...
      print("hi there , Api called for editing Verified data ");
    }
    }
    else{
