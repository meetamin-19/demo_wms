          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: Row(
                  children: [
                    SizedBox(child: kImgDateIcon,height: kFlexibleSize(20),width: kFlexibleSize(20)),
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(color:widget.passedDate == null ? Colors.black54 : Colors.black, fontSize: 15,fontWeight: FontWeight.w400)
                      ),
                    ),
                  ],
                ),
