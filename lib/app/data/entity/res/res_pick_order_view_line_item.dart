...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        itemLocationList: json["itemLocationList"] == null
            ? null
            : List<ItemLocationList>.from(json["itemLocationList"].map((x) => ItemLocationList.fromJson(x))),
        pickOrderSoDetail:
            json["pickOrderSODetail"] == null ? null : PickOrderSoDetail.fromJson(json["pickOrderSODetail"]),
...
class PickOrder {
  PickOrder({this.statusTerm, this.soNumber, this.pickOrderID});
